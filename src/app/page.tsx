        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-8">
              <span style={{ display: "inline-block", padding: "5px 14px", borderRadius: 20, border: "1px solid rgba(255,255,255,0.2)", fontSize: 11, letterSpacing: 1.5, textTransform: "uppercase", color: "#43ba7f", fontWeight: 700 }}>Client Portal</span>
              <h1 style={{ fontSize: 42, fontWeight: 800, margin: "16px 0 12px", lineHeight: 1.15 }}>
                Track your <em style={{ color: "#43ba7f", fontStyle: "normal" }}>service</em> &amp; request <em style={{ color: "#ff511a", fontStyle: "normal" }}>changes</em>
              </h1>
              <p style={{ color: "rgba(255,255,255,0.78)", fontSize: 16, maxWidth: 560 }}>Same trusted Brevan design. Sign in to view your bookings, check status, and comment directly on your service — admin replies in the same thread.</p>
