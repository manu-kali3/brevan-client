...
export default function Error({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <div style={{ maxWidth: 520, margin: "80px auto", textAlign: "center", padding: "0 16px" }}>
      <h1 style={{ fontSize: 22, color: "#b3261e" }}>Could not load bookings</h1>
      <p style={{ color: "#667085", marginTop: 8 }}>{error.message || "Please check your connection and try again."}</p>
